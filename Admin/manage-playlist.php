                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row row-cols-1 row-cols-md-4 g-4">
                            ...
                            $adminPlaylist = $database->getReference("users/$adminUid/playlist")->getValue();

                            // CHECK IF THERE ARE PLAYLISTS AVAILABLE
                            if ($adminPlaylist) {

                                // LOOP THROUGH EACH PLAYLIST
                                foreach ($adminPlaylist as $playlistKey => $playlist) {
                                    ?>
                                ...
                                echo '<div class="col"><p class="text-center">No playlists available for the admin</p></div>';
                            }
                            ?>
